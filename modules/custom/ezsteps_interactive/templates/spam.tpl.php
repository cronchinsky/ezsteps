...
<script type="text/javascript" src="/sites/ezsteps.edc.org/modules/custom/ezsteps_interactive/js/spamclick.js"></script>
	...
	<!-- draggable items-->
		...
		<div id="email_container">
			...
			<div id="spam_email">
				<div id="sender1"></div>
				<div id="awkward2"></div>
				<div id="spelling3"></div>
				<div id="website4"></div>
				<div id="alarmist5"></div>
			</div>
